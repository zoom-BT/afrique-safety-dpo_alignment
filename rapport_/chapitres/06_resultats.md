...
graines sont traitees en 6.5.

## 6.1 Ce que le pre-entrainement continu apporte
...
negative des demonstrations haoussa sous chaque modele. La figure [@fig:06_courbes_sft] en
donne les courbes.
...
chacune.](../figures/fig_06_courbes_sft.png)
{#fig:06_courbes_sft}
...
Ce constat se prolonge sur les axes de capacite. Le tableau [@tab:06_depart] donne l ecart
...
La derniere ligne du tableau [@tab:06_depart] est le contraste central du rapport. Sur
...
## 6.3 L alignement n amplifie pas l avantage

La question du stage porte sur l interaction entre backbone et alignement : l ecart entre
les deux bras change-t-il quand on les aligne ? La figure [@fig:06_six_etats_trois_axes]
donne les six etats sur les trois axes, et le tableau [@tab:06_ecarts] l ecart entre bras a
chaque etape.
...
axe.](../figures/fig_06_six_etats_trois_axes.png)
{#fig:06_six_etats_trois_axes}
...
[@fig:06_courbes_dpo] montre les marges de recompense du DPO : elles partent de 0,017 et
...
eux.](../figures/fig_06_courbes_dpo.png)
{#fig:06_courbes_dpo}
...
aligne. La section 6.5 montrera d ailleurs que ces marges finales ne se reproduisent pas
d une graine a l autre. Elles servent ici a une seule chose : etablir que l apprentissage a
eu lieu.

## 6.4 L exception : l interaction sur l axe Harmless

La quatrieme ligne du tableau [@tab:06_ecarts] se comporte autrement. En macro F1 sur
AfriHate, l ecart entre bras part de 0,021, non significatif, et atteint 0,078 apres SFT
puis 0,062 apres DPO. Il triple. La figure [@fig:06_interaction] decompose ce mouvement.
...
par bootstrap apparie.](../figures/fig_06_interaction.png)
{#fig:06_interaction}
...
La figure [@fig:06_intervalles_afrihate] donne les six quantites testees sur cet axe, pour
...
etats.](../figures/fig_06_intervalles_afrihate.png)
{#fig:06_intervalles_afrihate}

Une reserve doit accompagner ce resultat, et la figure [@fig:06_f1_par_classe] la
...
haineux.](../figures/fig_06_f1_par_classe.png)
{#fig:06_f1_par_classe}

## 6.5 La replication sur trois graines
...
**Le SFT se reproduit.** La figure [@fig:06_sft_trois_graines] superpose les six courbes,
et la figure [@fig:06_dispersion_graines] en donne la dispersion.

![Perte du SFT pour deux backbones et trois graines. Les trois courbes d un meme bras se
superposent presque.](../figures/fig_06_sft_trois_graines.png)
{#fig:06_sft_trois_graines}
...
graine.](../figures/fig_06_dispersion_graines.png)
{#fig:06_dispersion_graines}
...
figure [@fig:06_stabilite_metriques] met ce constat en regard des mesures sur donnees
jamais vues.
...
pas.](../figures/fig_06_stabilite_metriques.png)
{#fig:06_stabilite_metriques}
...
**Les conclusions tiennent.** La figure [@fig:06_replication_axes] compare l ecart entre
...
partout.](../figures/fig_06_replication_axes.png)
{#fig:06_replication_axes}
